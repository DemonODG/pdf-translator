...
def fix_russian_footnotes(final_text):
    ...
    # (в других книгах такие ссылки используются массово). Редкие ложные срабатывания
    # на математических верхних индексах (x¹, β²) из-за ошибки marker-single
    # корректируются вручную — не все случаи можно предусмотреть автоматически.

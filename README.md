...
Профессиональный конвейер для автоматизированного перевода англоязычной технической литературы (включая книги по программированию) на русский язык с сохранением исходной структуры, формул и блоков кода.
...
## 💡 Ключевое улучшение: Офлайн-режим для OCR
Мы устранили проблему «бесшумного» зависания `marker-pdf` при первом запуске. Ранее система пыталась скачать гигабайты весов моделей из интернета в процессе работы, что вызывало долгие задержки. Теперь все необходимые OCR-модели (Datalab) скачиваются заранее с помощью выделенного скрипта в локальный кэш, обеспечивая стабильную работу без доступа к сети.
